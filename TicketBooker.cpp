...
void works()
{
    ...
    while(true)
    {
        ...
        */
        ...
        while(temp != NULL)
        {
            cout << temp->customerID << " (Age: " << temp->age << ") " << "(Ready: " << temp->corresponding->ready << ") " << "(Wait: " << temp->corresponding->waiting << ") " << endl;
            temp = temp->next;
        }
        ...
        if(first_customer_that_is_doing_ticket != NULL)
        {
            cout << "Now working first_customer: " << first_customer_that_is_doing_ticket->customerID << endl;
        }
        cout << "Ticket Remaining Time: " << time_remaining_to_finish_ticket_reduction << endl;
        cout << "WRR: " << weighted_round_robin_time << endl;
